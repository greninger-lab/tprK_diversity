...
#path <- "/Users/uwvirongs/Documents/Michelle/tprk_pipeline/AS_files_redo4"
#filename <- "/Users/uwvirongs/Documents/Michelle/tprk_pipeline/AS_files_redo4/allreads_filtered.csv"
