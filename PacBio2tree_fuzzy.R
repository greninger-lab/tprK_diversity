...
## Get count of TprK sequences by sample
aggregate(d2$taxa, list(d2$sample), length)
...
ggsave(path=paste(path,"/Figures",sep=""),filename="PacBio_Tree_Filtered2.pdf",height = 6, width=4)
